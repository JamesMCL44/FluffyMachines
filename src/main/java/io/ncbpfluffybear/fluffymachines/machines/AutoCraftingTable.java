...
public class AutoCraftingTable extends SlimefunItem implements EnergyNetComponent {
        ...
        new BlockMenuPreset(getId(), "&6自動合成檯") {
            ...
            public void newInstance(@Nonnull BlockMenu menu, @Nonnull Block b) {
                if (!BlockStorage.hasBlockInfo(b)
                    ...
                    menu.replaceExistingItem(4, new CustomItem(Material.GUNPOWDER, "&7運作中: &4\u2718",
                        "", "&e> 單擊啟動"));
                    ...
                    menu.replaceExistingItem(4, new CustomItem(Material.REDSTONE, "&7運作中: &2\u2714",
                        "", "&e> 單擊停用"));
                    menu.addMenuClickHandler(4, (p, slot, item, action) -> {
    ...
    protected void constructMenu(BlockMenuPreset preset) {
        ...
        for (int i : keyBorder) {
            preset.addItem(i, new CustomItem(new ItemStack(Material.YELLOW_STAINED_GLASS_PANE), "&e&l關鍵物品槽"),
                (p, slot, item, action) -> false);
        }

        preset.addItem(statusSlot, new CustomItem(new ItemStack(Material.YELLOW_STAINED_GLASS_PANE), "&e&l待命中"),
            (p, slot, item, action) -> false);
        ...
        preset.addItem(2, new CustomItem(new ItemStack(Material.CRAFTING_TABLE), "&e合成表", "",
                "&b放入想要合成的材料", "&e放入目標合成品",
                "&4只限原始合成表"
            ),
            (p, slot, item, action) -> false);
